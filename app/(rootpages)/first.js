    ...
    render(){
        return(
            <SafeAreaView style={{width: Dimensions.get('window').width}}>
                ...
                <ScrollView ref={this.scrollViewRef} style={{ display:!this.state.loading?'flex':'none', marginTop:60, overflowX: 'none'}} 
                    ...
                    <View style={styles.gallDiv1}>
                        <View style={styles.textCont1}>
                            <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize: 30}}>Your Friends are Here!</Text>
                            <Text style={{fontFamily:'Chakra Petch Regular', fontSize: 14}}>PacPlay, where friends stake together and win together.</Text>
                        </View>
                    ...
                    <View style={styles.gallDiv2}>
                        ...
                        <View style={styles.textCont2}>
                            <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize: 30, textAlign: 'right'}}>"Bet, stake and celebrate with friends!"</Text>
                            <Text style={{fontFamily:'Chakra Petch Regular', fontSize: 14, textAlign: 'right'}}>Join the ultimate betting experience. Invite friends, stake bets and let the winnings flow!</Text>
                        </View>
                    </View>
                    <View style={styles.gallDiv3}>
                        ...
                        <View style={styles.textCont3}>
                            <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize: 30, textAlign: 'center'}}>"Double the fun, double the stakes!</Text>
                            <Text style={{fontFamily:'Chakra Petch Regular', fontSize: 14, textAlign: 'center'}}>"Turn bets into shared victories! Invite friends to join your betting circle and enjoy winning together"</Text>
                        </View>
                    </View>
                </ScrollView>
                <View style={{width: Dimensions.get('window').width, flexDirection:'column', alignItems:'center', marginTop: 20}}>
                    <TouchableOpacity style={{flexDirection:'row', alignItems: 'center', justifyContent: 'center', marginTop:20}} onPress={()=>{navigation.navigate('createacc');}}>
                    ...
                    <TouchableOpacity style={{flexDirection:'row', alignItems: 'center', justifyContent: 'center', marginTop:15}} onPress={()=>{navigation.navigate('loginacc');}} >
                        <Image style={{width:240, height:41}} source={require('./../../assets/whiterect.png')}/>
                        <Text style={{ position:'absolute', fontFamily:'Chakra Petch Regular', color:'black'}}>Login to account</Text>
                    </TouchableOpacity>
