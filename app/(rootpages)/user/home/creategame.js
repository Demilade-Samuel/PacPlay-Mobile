        ...
        return(
            <View style={{flexDirection:'column', alignItems:'flex-start', justifyContent:'flex-start', backgroundColor:this.state.screenmode==='dark'?'#181818':'white'}}>
                ...
                <ScrollView  style={{display:!this.state.loading?'flex':'none', paddingLeft:24, paddingRight:24, width: Dimensions.get('window').width, height:Dimensions.get('window').height*0.9, marginTop:20}}>
                    <Text style={{fontFamily:'Chakra Petch Regular', fontSize:18, display:this.state.userdata.username?'flex':'none', color:this.state.screenmode==='dark'?'white':'black'}}>
                        {'Creator: @'+this.state.userdata.username}
                    </Text>
                    ...
                    <TextInput
                        ...
                        style={{width:Dimensions.get('window').width*0.9, fontFamily:'Chakra Petch Regular', fontSize:18, borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'#928E8E', paddingLeft:10, paddingRight:10, paddingTop:10, paddingBottom:10, borderRadius:8, color:this.state.screenmode==='dark'?'white':'black'}}
                    />
                    ...
                    <TextInput
                        ...
                        style={{width:Dimensions.get('window').width*0.9, height:148, borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'#928E8E', fontFamily:'Chakra Petch Regular', fontSize:18, padding:10, borderRadius:8, color:this.state.screenmode==='dark'?'white':'black'}}
                    />
                    ...
                    <View style={{width:372, flexDirection:'row', alignItems:'center', justifyContent:'space-between', paddingTop:20, paddingBottom:20, marginTop:20, borderWidth:1, borderBottomColor:'#C8D1DB', borderTopColor:'#C8D1DB', borderRightColor:'rgba(0,0,0,0)', borderLeftColor:'rgba(0,0,0,0)'}}>
                        <Text style={{fontFamily:'Chakra Petch Regular', fontSize:20, marginLeft:10, color:this.state.screenmode==='dark'?'white':'black'}}>Decider</Text>
                        <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between', }}>
                            <Text style={{fontSize:16, fontFamily:'Chakra Petch Regular', color:this.state.bettype==='h2h'? this.state.screenmode==='dark'?'#1E9E40':'#4285F4' : '#C8D1DB', marginRight:12}}>Head 2 Head</Text>
                            <Switch
                                ...
                                circleBorderWidth={4}
                            />
                            <Text style={{fontSize:16, fontFamily:'Chakra Petch Regular',  color:this.state.bettype==='admin'? this.state.screenmode==='dark'?'#1E9E40':'#4285F4' : '#C8D1DB', marginLeft:12}}>Admin</Text>
                        </View>
                    </View>

                    <View>
                    <View style={{marginTop:20, flexDirection:'row', alignItems:'center', justifyContent:'flex-start', width:Dimensions.get('window').width*0.9, height:50, borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'black', borderRadius:8, paddingRight:15}}>
                        <TouchableOpacity style={{backgroundColor:this.state.screenmode?'#D3D4D7':'rgba(0,0,0,0)', paddingTop:12, paddingBottom:12, paddingLeft:20, paddingRight:20, borderTopLeftRadius:7, borderBottomLeftRadius:7 }}>
                        ...
                        <TextInput
                            ...
                            style={{marginLeft:10, height:50, width:358, outlineStyle:'none', fontSize:28, fontFamily:'Chakra Petch SemiBold', color:this.state.screenmode==='dark'?'white':'black'}}
                        />
                    </View>
                    ...
                    <View style={{display:this.state.bettype==='admin'?'flex':'none'}}>
                        ...
                        <View style={{display:this.state.wagerstructure==='default'?'flex':'none'}}>
                            <View style={{width:Dimensions.get('window').width*0.9, marginTop:25, flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
                                ...
                                <TouchableOpacity style={{borderRadius:6, backgroundColor:this.state.screenmode==='dark'? this.state.gametype==='TVT'?'#1E9E40':'rgba(200, 200, 200, 0.7)' : this.state.gametype==='TVT'?'black':'rgba(200, 200, 200, 0.7)', width:140, height:45, flexDirection:'row', alignItems:'center', justifyContent:'center'}} onPress={()=>{this.setState({gametype: 'TVT'});}}>
                            ...
                            <View style={{flexDirection:'column', alignItems:'center', justifyContent:'flex-start', marginTop:25, width:Dimensions.get('window').width*0.9, paddingLeft:24, paddingRight:24}}>
                                <Text style={{fontFamily:'Chakra Petch Regular', fontSize:20, width:Dimensions.get('window').width*0.9, color:this.state.screenmode==='dark'?'white':'black'}}>Contestants</Text>
                                <View style={{flexDirection:'row', alignItems:'flex-start', justifyContent:'center', width:Dimensions.get('window').width*0.9, marginTop:10, boxSizing:'border-box'}}>
                                    <View style={{width:190, flexDirection:'column', justifyContent:'flex-start', alignItems:'flex-start', /*borderWidth:1, borderLeftColor:'black'*/}}>
                                        <TextInput  
                                            ...
                                            style={{width:180, fontFamily:'Chakra Petch Regular', fontSize:18, color:this.state.screenmode==='dark'?'rgb(60,100,255)':'#0F19A6', borderWidth:1, borderColor:this.state.screenmode==='dark'?'rgb(60,100,255)':'#0F19A6', outlineStyle:'none', paddingLeft:5, paddingRight:5, paddingTop:8, paddingBottom:8, borderRadius:6, marginTop:5}}
                                        />
                                    </View>
                                    <View style={{width:190, flexDirection:'column', justifyContent:'flex-start', alignItems:'flex-end', /*borderWidth:1, borderLeftColor:'black'*/}}>
                                        <TextInput
                                            ...
                                            style={{width:180, fontFamily:'Chakra Petch Regular', color:this.state.screenmode==='dark'?'rgb(255,80,80)':'#F41919', fontSize:18, borderWidth:1, borderColor:this.state.screenmode==='dark'?'rgb(255,80,80)':'#F41919', outlineStyle:'none', paddingLeft:5, paddingRight:5, paddingTop:8, paddingBottom:8, borderRadius:6, marginTop:5}}
                                        />
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={{marginTop:25, width:Dimensions.get('window').width*0.9, flexDirection:'column', justifyContent:'flex-start', alignItems:'center'}}>
                                ...
                                <View style={{marginTop:15, flexDirection:'row', alignItems:'center', justifyContent:'flex-start'}}>
                                    ...
                                    />
                                    <Text style={{marginLeft:10, color:this.state.screenmode==='dark'?'white':'black', fontSize:16, fontFamily:'Chakra Petch Regular'}}>Add a draw wager</Text>
                                </View>
                            </View>
                        </View>
