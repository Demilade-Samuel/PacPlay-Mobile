        ...
        return(
            <View style={{backgroundColor:this.state.screenmode==='dark'?'#181818':'white', height:Dimensions.get('window').height}}>
                ...
                <View style={{display:this.state.loading?'none':'flex', flexDirection:'row', alignItems:'center', justifyContent:'flex-start', marginTop:20}}>
                    ...
                    <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:24, marginLeft:108, color:this.state.screenmode==='dark'?'white':'black'}}>Withdraw</Text>
                </View>
                <View style={{display:this.state.loading?'none':'flex', width:Dimensions.get('window').width, paddingLeft:35, paddingRight:30, marginTop:30}}>
                    <View style={{flexDirection:'column', alignItems:'flex-start', justifyContent:'flex-start'}}>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:18, color:this.state.screenmode==='dark'?'white':'grey'}}>Location</Text>
                        <Dropdown
                            data={this.state.locations}
                            style={{borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'grey', borderRadius:8, width:200, paddingLeft:10, paddingRight:10, marginTop:4}}
                            labelField="label"
                            valueField="value"
                    ...
                    <View style={{marginTop:20}}>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:18, color:this.state.screenmode==='dark'?'white':'grey'}}>Bank</Text>
                        <View style={{flexDirection:'row', alignItems:'center', justifyContent:'flex-start'}}>
                            <Dropdown
                                ...
                                style={{borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'grey', borderRadius:8, width:320, paddingLeft:10, paddingRight:10, marginTop:4}}
                    ...
                    <View style={{marginTop:20}}>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:18, color:this.state.screenmode==='dark'?'white':'grey'}}>Account Number</Text>
                        <TextInput
                            onChangeText={(e)=>{this.setState({accountnumber: e});}}
                            value={this.state.accountnumber}
                            keyboardType='numeric'
                            style={{marginTop:4, width:320, height:44, fontSize:18, fontFamily:'Chakra Petch Semibold', paddingLeft:12, paddingRight:12, borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'grey', borderRadius:8, color:this.state.screenmode==='dark'?'white':'black'}}
                        />
                    ...
                    <View style={{marginTop:20}}>
                        <Text style={{fontFamily:'Chakra Petch SemiBold', fontSize:18, color:this.state.screenmode==='dark'?'white':'grey'}}>Amount</Text>
                        <View style={{width:320, marginTop:4, height:50, flexDirection:'row', alignItems:'center', justifyContent:'flex-start', borderWidth:1, borderColor:this.state.screenmode==='dark'?'white':'grey', borderRadius:8, paddingRight:15}}>
                            <View style={{backgroundColor:this.state.screenmode?'#D3D4D7':'rgba(0,0,0,0)', paddingTop:15, paddingBottom:15, paddingLeft:10, paddingRight:20, borderTopLeftRadius:6, borderBottomLeftRadius:6}}>
                            ...
                            <TextInput
                                ...
                                keyboardType='numeric'
                                style={{outlineStyle:"none", marginLeft:8, marginRight:12, fontSize:22, fontFamily:'Chakra Petch SemiBold', height:40, color:this.state.screenmode==='dark'?'white':'black'}}
                            />
                        </View>
                    ...
                    <TouchableOpacity style={{width:Dimensions.get('window').width-80, height:56, flexDirection:'row', alignItems:'center', justifyContent:'center', borderRadius:8, marginTop:80,  backgroundColor:this.state.screenmode==='dark'?'#1E9E40':'black'}} onPress={()=>{this.withdraw();}}>
